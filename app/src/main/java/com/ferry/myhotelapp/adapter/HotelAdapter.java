...
/**
 * Created by Student6 on 10/02/2016.
 */
public class HotelAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.imgPhoto = (ImageView)convertView.findViewById(R.id.img_item_url);
    ...
    static class ViewHolder{
        TextView txtName,txtStar, txtDescription, txtAddress;
        ImageView imgPhoto;
    }
}
