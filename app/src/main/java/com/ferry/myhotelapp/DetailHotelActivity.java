...
public class DetailHotelActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ImageView imgGalleryA, imgGalleryB, imgGalleryC, imgMore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPrice.setText("Mulai dari Rp. 700K");
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng pos = new LatLng(Double.parseDouble(mHotelItem.getLatitude()), Double.parseDouble(mHotelItem.getLongitude()));
                mMap.addMarker(new MarkerOptions().position(pos).title(mHotelItem.getName()));
    ...
    private void shareContent(){
        ...
        sharingIntent.setType("tex/plain");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_item_a:
                ImageDetailActivity.toImageDetailActivity(DetailHotelActivity.this, imageUrls[1]);
                break;
